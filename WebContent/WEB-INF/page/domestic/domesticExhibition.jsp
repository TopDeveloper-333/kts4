		...
		<div id="searchOptionArea">
			...
			<table id="orderTable" style="float:left">
				...
				<tr>
					<td>掛率</td>
					<td>
						<nested:text property="itemRateOver" maxlength="3" size="4" styleClass="numText right"></nested:text><label> ％</label>
...
<!-- 表示分 -->
			...
			<nested:iterate property="domesticExhibitionList" id="seachList" indexId="idx">
				<tr class="domestic">
					...
					<!-- 掛率 -->
					<td class="w80"><nested:text styleClass="itemRateOver numText right priceSize" property="itemRateOver" maxlength="4" />&nbsp;％</td>
					<!-- 送料 -->
			...
			<nested:iterate property="addDomesticExhibitionList" indexId="idx">
				<tr class="addDomestic">
					...
					<!-- 掛率：追加 -->
					<td class="w80"><nested:text styleClass="addItemRateOver numText right priceSize" property="itemRateOver" maxlength="4"  />&nbsp;％</td>
					<!-- 送料：追加 -->
...
// 			}
	...
	function purchasingCostCalc(index) {
		...
		var postage = $(".postage").eq(index).val();
		...
		var costArray = calcCost(listPrice,itemRateOver); // return [intValue1, intValue2, power]
		calc = parseInt((costArray[0] * costArray[1]) / costArray[2]);
	...
	function addPurchasingCostCalc(index) {
		...
		var postage = $(".addPostage").eq(index).val();
