...
//	public static final int UPLOAD_EXCEL_SET_DOMESTIC_ITEM_COLUMN = 19;
	 ...
	 */
	public static final String ITEM_INFO_LIST_TEMPLATE_PATH = "/excelTemplate/itemInfoListTemplate.xls";
	/**
	 * 在庫一覧：商品情報のダウンロードテンプレートパス：権限無
	 */
	public static final String ITEM_INFO_LIST_NOT_AUTH_PATH = "/excelTemplate/itemInfoListNotAuthTemplate.xls";

	/**
	 * 在庫一覧：在庫情報のダウンロードテンプレートパス
	 */
	public static final String STOCK_ITEM_INFO_LIST_TEMPLATE_PATH = "/excelTemplate/stockItemInfoListTemplate.xls";

	/**
	 * 在庫一覧：価格情報のダウンロードテンプレートパス:DL権限有
	 */
	public static final String PRICE_INFO_LIST_TEMPLATE_PATH = "/excelTemplate/priceInfoListTemplate.xls";

	/**
	 * 在庫一覧：価格情報のダウンロードテンプレートパス:DL権限無
	 */
	public static final String NOT_AUTH_PRICE_INFO_LIST_TEMPLATE_PATH = "/excelTemplate/notAuthpriceInfoListTemplate.xls";

	/**
	 * 在庫一覧：新在庫情報のダウンロードテンプレートパス:DL権限有
	 */
	public static final String ITEM_ALL_LIST_TEMPLATE_PATH = "/excelTemplate/itemAllListTemplate.xls";

	/**
	 * 在庫一覧：新在庫情報のダウンロードテンプレートパス:DL権限無
	 */
	public static final String ITEM_ALL_LIST_TEMPLATE_PATH_NOT_AUTH = "/excelTemplate/itemAllListNotAuthTemplate.xls";
